...
class google_drive_integration:
    ...
    baseFolderId =  'EXAMPLE_FOLDER'  #Folder to use. Share with driveaccess@tech-essence.iam.gserviceaccount.com beforehand.
    ...
    def perform_upload(filePath, optionfoldername):
        ...
        google_drive_integration.load_file(optionfolderid,filePath,"output.zip")
        print("File Loaded")


google_drive_integration.perform_upload("test55.txt", "option1")
